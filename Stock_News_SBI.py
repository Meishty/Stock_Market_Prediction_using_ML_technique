...
googlenews.search('State Bank of India')
df_f=pd.DataFrame()
for i in range(1,31):
...
df=pd.concat([df_f,df_f1,df_f2,df_f3],axis=0)
...
news_df.to_excel("/home/pogo/Desktop/Ba/Desktop/Books/Capstone/Phase 2/Parallel/Data/NEWS/SBI_articles_Jan.xlsx",index=0)
